"""Demo script for the deduplication helper function.

Run directly to see the compound-deduplication logic in action:

    python scripts/demo_deduplication.py
"""

from wordnet_autotranslate.pipelines.langgraph_translation_pipeline import LangGraphTranslationPipeline
